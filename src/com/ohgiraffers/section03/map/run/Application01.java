...
public class Application01 {
    public static void main(String[] args) {
        /* HashMap을 이해하고 활용 할수 있다. */
        HashMap hmap = new HashMap();

        /* 키와 값을 쌍으로 저장한다.
        *  키와 값은 반드시 개체여야 한다.*/
        hmap.put("one", new Date());
        hmap.put(12, "red apple");           //1키값이 같으면 밑에 잇는게 출력
        hmap.put(33, 123);
        System.out.println("hmap : " + hmap);

        /* 키 값은 중복 저장할수 없다. 새로운 값으로 덮어쓰기 된다 .*/
        hmap.put(12, "yellow banana");  //1키값이 같으면 밑에 잇는게 출력        //2 값 객체는 중복
        System.out.println("hmap : " + hmap);

        /* 값 객체는 중복 저장할 수 있다. */
        hmap.put(9, "yellow bananana");  //2 값 객체는 중복
        System.out.println("hmap : " + hmap);
        ...
        /* 2. 저장 된 value 객체들만 values()로 Collection으로 만든ㄷ 뒤 iterator로 값에 대한 목록을 만든다.  */
